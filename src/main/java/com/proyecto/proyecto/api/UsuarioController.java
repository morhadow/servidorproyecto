        ...
        if (oUsuarioEntity == null) {
            ...
            if (oUsuarioEntity.getTipousuario().getId() == 1) {
                if (oNewUsuarioEntity.getId() == null) {
                    oNewUsuarioEntity.setPassword("B28AD89A06F3FB2C0AD08D066266B03B65DF695E6D7FEDFE0601846621BC2425");
        ...
        if (oUsuarioEntity2 == null) {
            ...
            if (oUsuarioEntity2.getTipousuario().getId() == 1) {
                if (oUsuarioRepository.existsById(id)) {
                    ...
                    oUsuarioEntity.setPassword("B28AD89A06F3FB2C0AD08D066266B03B65DF695E6D7FEDFE0601846621BC2425");
